...
define('SITE_NAME',"www.flashpoker.it");
define('SERVER_NAME',"http://www.flashpoker.it");
define('CONST_PUBIC_PATH',"../public/");
define('CONST_IMAGE_PATH',"../public/imgs/");
define('BACKGROUND_IMAGE',"../images/bkg.gif");
define('PKR_SITE_TITLE',"www.flashpoker.it - Poker OnLine Free Texas Holdem");
...
define('PKR_ROYALFLUSH','royal flush');
define('PKR_STRAIGHTFLUSH','poker');
define('PKR_FOUROFAKIND','four of a kind');
define('PKR_FULLHOUSE','fullhouse');
define('PKR_FLUSH','flush');
define('PKR_STRAIGHT','straight');
define('PKR_THREEOFAKIND','three of a kind');
define('PKR_TWOPAIR','twopair');
define('PKR_PAIR','pair');
define('PKR_HIGHCARD','highcard');
