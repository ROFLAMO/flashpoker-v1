...
* @package xml
* XML Parser class.
* This class changes php arrays into xml text or xmls into array.
*/
class xml
{
	var $arr_types = array('usr', 'msg', 'mail', 'response');
...
//-------------------------------------------------------------------
	...
	*/
	function prv_array_to_xml($arg_arr_array, $arg_int_pad_number=0, $arg_str_pad="")
	{
		...
		{
			$str_xml .= $this->pad($arg_int_pad_number, $arg_str_pad) . "<a key=\"" . htmlspecialchars($k) . "\">";//.$s_cdata;
			...
			$str_xml .= $this->pad($arg_int_pad_number, $arg_str_pad) ."</a>"; //$e_cdata
