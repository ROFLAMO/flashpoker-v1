 ...
 *         (c) 2004 PhpMemX.Net
 *
 * $Id: EncryptedButtons.php,v 1.2 2004/10/31 18:30:23 chrishogben Exp $
 *
 ...
 *
 * @package PayPal_EncryptedButtons
 * @author Chris Hogben <chrishogben@gmail.com>
 * @version 1.1
 *
 * Please see PayPal/EncryptedButtons/Config.php
...
// require_once "PayPal/EncryptedButtons/Config.php";
...
*/
        ...
        */
        function encryptButtonData() {
                ...
                $exec = "./openssl smime -sign -in ".$this->config->tempdir.$this->_rnd.".1 -signer ".$this->config->my_public." -inkey ".$this->config->my_private." -outform der -nodetach -binary > ".$this->config->tempdir.$this->_rnd.".2";
                echo "<br>".$exec;
                ...
                $exec = "./openssl smime -encrypt -des3 -binary -outform pem ".$this->config->paypal_public." < ".$this->config->tempdir.$this->_rnd.".2 > ".$this->config->tempdir.$this->_rnd.".3";
                echo "<br>".$exec;
                
                $status2 = $exec;
                
                $this->encryptedButton = trim(file_get_contents($this->config->tempdir.$this->_rnd.".3"));
                echo "<br>".$this->encryptedButton;                
